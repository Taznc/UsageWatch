...
export const WIDGET_THEMES: Record<WidgetThemeId, WidgetThemeDefinition> = {
  ...
  "orbit-gauges": {
    ...
    cardRadius: "22px",
    cardSurface: "linear-gradient(180deg, rgba(10, 14, 24, 0.92), rgba(5, 7, 15, 0.9))",
  ...
  "pinboard-mini": {
    ...
    cardRadius: "18px",
    cardSurface: "linear-gradient(180deg, rgba(11, 17, 25, 0.9), rgba(6, 10, 16, 0.86))",
    cardBorder: "1px solid rgba(137, 207, 255, 0.15)",
    cardShadow: "0 12px 24px rgba(0, 0, 0, 0.18)",
    cardBlur: "blur(14px) saturate(1.16)",
  ...
  "terminal-deck": {
    ...
    cardRadius: "8px",
    cardSurface: "linear-gradient(180deg, rgba(2, 8, 2, 0.94), rgba(0, 4, 0, 0.92))",
