...
export const WIDGET_THEMES: Record<WidgetThemeId, WidgetThemeDefinition> = {
  "rainmeter-stack": {
    ...
    compactBehavior: "Ultra-compact strips this down to tight slabs with shorter sublines and smaller badges.",
    layoutFamily: "slab-stack",
    headerStyle: "capsule",
    showSecondaryByDefault: true,
    stackGap: density(3, 6, 12),
    cardMinWidth: density(160, 220, 300),
    cardMinHeight: density(44, 72, 110),
    cardPadding: density("5px 8px 5px", "9px 12px 9px", "16px 20px 16px"),
    cardRadius: "24px",
    ...
    iconSize: density(16, 28, 48),
    titleStyle: "700 11px/1 'Aptos', 'Segoe UI Variable Display', 'Segoe UI', sans-serif",
    primarySize: density(
      "600 14px/0.95 'Aptos Display', 'Segoe UI Variable Display', 'Segoe UI', sans-serif",
      "600 20px/0.95 'Aptos Display', 'Segoe UI Variable Display', 'Segoe UI', sans-serif",
      "600 31px/0.95 'Aptos Display', 'Segoe UI Variable Display', 'Segoe UI', sans-serif",
    ),
    secondaryStyle: density(
      "500 8px/1.15 'Aptos', 'Segoe UI', sans-serif",
  ...
  "gauge-tower": {
    ...
    compactBehavior: "Ultra-compact shrinks dials to minimal rings with centered values.",
    bestForLaptop: true,
    ...
    cardMinWidth: density(60, 80, 110),
    cardMinHeight: density(64, 90, 130),
    cardPadding: density("4px 3px 3px", "6px 5px 5px", "10px 8px 8px"),
    cardRadius: "16px",
    ...
    primarySize: density(
      ...
      "700 20px/1 'Aptos Display', 'Segoe UI Variable Display', sans-serif",
    ),
    secondaryStyle: density(
      "500 7px/1.1 'JetBrains Mono', ui-monospace, monospace",
      "500 8px/1.1 'JetBrains Mono', ui-monospace, monospace",
      "500 9px/1.2 'JetBrains Mono', ui-monospace, monospace",
    ),
    progressTrack: "rgba(255,255,255,0.08)",
    gaugeThickness: density(4, 5, 7),
    previewStyle: "dial",
  },
  "side-rail": {
    id: "side-rail",
    ...
    compactBehavior: "Ultra-compact becomes a true side strip: abbreviations, bars, and essential values only.",
    bestForLaptop: true,
    ...
    cardMinWidth: density(140, 200, 280),
    cardMinHeight: density(32, 48, 72),
    cardPadding: density("3px 6px 3px", "5px 8px 5px", "8px 12px 9px"),
    cardRadius: "14px",
    ...
    iconBackground: "rgba(255,255,255,0.04)",
    iconSize: density(10, 14, 20),
    titleStyle: "700 9px/1 'JetBrains Mono', ui-monospace, monospace",
    primarySize: density(
      "700 10px/1 'Aptos', 'Segoe UI', sans-serif",
  ...
  "mono-ticker": {
    ...
    compactBehavior: "Ultra-compact becomes a dense row of terse chips with minimal dividers and almost no prose.",
    bestForLaptop: true,
    layoutFamily: "micro-rail",
    headerStyle: "ghost",
    showSecondaryByDefault: false,
    useAbbreviatedLabels: true,
    stackGap: density(2, 4, 8),
    cardMinWidth: density(140, 200, 280),
    cardMinHeight: density(30, 44, 66),
    cardPadding: density("3px 6px 3px", "5px 8px 5px", "8px 12px 8px"),
    cardRadius: "999px",
    ...
    titleStyle: "700 8px/1 'JetBrains Mono', ui-monospace, monospace",
    primarySize: density(
      "600 10px/1 'Aptos', 'Segoe UI', sans-serif",
      "600 12px/1 'Aptos', 'Segoe UI', sans-serif",
  ...
  "signal-deck": {
    ...
    compactBehavior: "Ultra-compact keeps the panel grid but trims meter width and collapses support copy.",
    ...
    stackGap: density(3, 6, 10),
    cardMinWidth: density(160, 220, 300),
    cardMinHeight: density(40, 60, 90),
    cardPadding: density("5px 7px 5px", "7px 10px 7px", "14px 16px 15px"),
    cardRadius: "12px",
  ...
  "matrix-rain": {
    ...
    compactBehavior: "Ultra-compact collapses to tight glyphed strips with minimal chrome.",
    ...
    cardMinWidth: density(160, 220, 300),
    cardMinHeight: density(40, 60, 90),
    cardPadding: density("4px 8px 4px", "7px 10px 7px", "12px 16px 12px"),
    cardRadius: "4px",
    ...
    iconSize: density(12, 16, 22),
    titleStyle: "700 8px/1 'JetBrains Mono', ui-monospace, monospace",
    primarySize: density(
      "700 13px/1 'JetBrains Mono', ui-monospace, monospace",
      "700 16px/1 'JetBrains Mono', ui-monospace, monospace",
